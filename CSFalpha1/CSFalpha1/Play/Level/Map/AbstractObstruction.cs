...
namespace CSFalpha1.Play.Level.Map
{
    public abstract class AbstractObstruction
    {
        ...
        protected AbstractObstruction() { ConsolePrinter.RedPrint("Do not use the default constructor!"); }
        protected AbstractObstruction(int x, int y)
        {
            this.x = x;
            this.y = y;
            collideUp = false;
        ...
        public virtual bool GetCollide(int a)
        {
            switch (a)
            {
                ...
                case 3:
                    return collideRight;
                default:
                    ConsolePrinter.RedPrint("Error: Can only call Obstruction.GetCollide() with an argument: integer between 0-3.");
                    return false;
            }
        }
        public virtual void UnCollide(int a)
        {
            switch (a)
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    ConsolePrinter.RedPrint("Error: Can only call Obstruction.UnCollide() with an argument: integer between 0-3.");
                    break;
            }
        }
    }
